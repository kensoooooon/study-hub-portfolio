...
class SpecificLinearEquationGeneratorTests(SimpleTestCase):
    ...
    @patch("math_trainer.math_process.specific_linear_equation_generator.random", return_value=0.9)
    ...
    @patch("math_trainer.math_process.specific_linear_equation_generator.random", return_value=0.1)
